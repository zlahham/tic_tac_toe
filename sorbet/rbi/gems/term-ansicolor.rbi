...
class Term::ANSIColor::RGBColorMetrics::YUV::YUVTriple < Anonymous_Struct_3
...
class Term::ANSIColor::RGBColorMetrics::CIEXYZ::CIEXYZTriple < Anonymous_Struct_4
  def self.from_rgb_triple(rgb_triple); end
...
class Term::ANSIColor::RGBColorMetrics::CIELab::CIELabTriple < Anonymous_Struct_5
  def self.from_rgb_triple(rgb_triple); end
  extend Term::ANSIColor::RGBColorMetricsHelpers::NormalizeRGBTriple
  include Term::ANSIColor::RGBColorMetricsHelpers::WeightedEuclideanDistance
end
